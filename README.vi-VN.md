...
- [✨ Tính năng](#-tính-năng)
  - [`1` Tải tập tin/Cơ sở kiến thức](#1-tải-tập-tincơ-sở-kiến-thức)
  - [`2` Hỗ trợ nhiều nhà cung cấp dịch vụ mô hình](#2-hỗ-trợ-nhiều-nhà-cung-cấp-dịch-vụ-mô-hình)
  - [`3` Hỗ trợ Mô hình Ngôn ngữ Lớn (LLM) cục bộ](#3-hỗ-trợ-mô-hình-ngôn-ngữ-lớn-llm-cục-bộ)
  - [`4` Nhận dạng hình ảnh mô hình](#4-nhận-dạng-hình-ảnh-mô-hình)
  - [`5` Trò chuyện bằng giọng nói TTS & STT](#5-trò-chuyện-bằng-giọng-nói-tts--stt)
  - [`6` Tạo hình ảnh từ văn bản](#6-tạo-hình-ảnh-từ-văn-bản)
  - [`7` Hệ thống plugin (Function Calling)](#7-hệ-thống-plugin-function-calling)
  - [`8` Agent Market (GPTs)](#8-agent-market-gpts)
  - [`8` Thị Trường Agent (GPTs)](#8-thị-trường-agent-gpts)
  - [`9` Hỗ trợ Cơ sở dữ liệu cục bộ / Từ xa](#9-hỗ-trợ-cơ-sở-dữ-liệu-cục-bộ--từ-xa)
  - [`10` Hỗ trợ Quản lý nhiều người dùng](#10-hỗ-trợ-quản-lý-nhiều-người-dùng)
  - [`11` Ứng dụng web tiến bộ (PWA)](#11-ứng-dụng-web-tiến-bộ-pwa)
  - [`12` Thích ứng với thiết bị di động](#12-thích-ứng-với-thiết-bị-di-động)
  - [`13` Chủ đề tùy chỉnh](#13-chủ-đề-tùy-chỉnh)
...
<!-- DANH SÁCH CÁCH NHÀ CUNG CẤP DỊCH VỤ -->
